...
var __globalConfigUrl = 'http://api.handday.com/common/appsetting';
...
var buildConfigCache = function (globalConfigUrl) {
    ...
    var res = require('sync-request')('POST', globalConfigUrl || __globalConfigUrl, { 'headers': { 'X-Request-With': 'AppSettingGeter' } });
